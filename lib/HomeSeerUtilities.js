					...
					if (config.accessories[i].can_dim === undefined)
						{
							...
							if ( CurrentHomeSeerDevice.device_type_string && ((CurrentHomeSeerDevice.device_type_string == "Z-Wave Switch Binary") || (CurrentHomeSeerDevice.device_type_string == "Z-Wave Switch") || (CurrentHomeSeerDevice.device_type_string.search("Switch Binary") != (-1) ) ))
							{
