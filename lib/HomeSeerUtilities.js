...
var checkConfig = function(config)
{
	...
	{ 
		...
		for (let thisAccessoryConfigData of config.accessories)
		{
			...
			{
				let isVariable = (globals.findControlPairByCommand(thisAccessoryConfigData.ref, "Dim") === undefined) ? false : true;
				if (isVariable)
				{
			...
			{
				let isDimmer = (globals.findControlPairByCommand(thisAccessoryConfigData.ref, "Dim") === undefined) ? false : true;
				let isFan = (globals.findControlPairByCommand(thisAccessoryConfigData.ref, "DimFan") === undefined) ? false : true;
				if (isDimmer || isFan)
				{
