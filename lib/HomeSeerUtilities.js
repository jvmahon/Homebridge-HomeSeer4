...
// var Characteristic = require("../index.js").Characteristic;
...
var checkConfig = function(config)
{
	...
	{ 
		...
		for (let thisAccessoryConfigData of config.accessories)
		{
			...
			if (thisAccessoryConfigData.batteryRef === 0)
			{
				globals.log(chalk.red(`You manually set a batteryRef to a value of 0. This inhibits automatic battery checking. No battery will be set for device: ${thisAccessoryConfigData.ref}` ));
			}
			else
			{
