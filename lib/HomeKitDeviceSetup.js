...
exports.setupServices = function (that, services)
{
    ...
    //globals.log("DEBUG - Executing setupServices(obj, obj, obj, obj, obj, obj, obj)");
			...
			globals.sendHS = function(ref, value, sendOnlyOnChange) 
			{
				...
				if (	((sendOnlyOnChange === undefined) || (sendOnlyOnChange === true) )
							&& (globals.getHSValue(ref) == value) )
					{
						globals.log(yellow("*Debug Experimental * - Inhibiting send of value %s to reference %s because HomeSeer already has that value"), value, ref);
						return;
					}
