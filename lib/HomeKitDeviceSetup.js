...
/////////////////////////////////////////////////////////////
	...
	switch (that.config.type) 
	{
		...
		case "GarageDoorOpener": 
		{
			...
			/* thisService.control = [];
			thisService.control.lockValue = that.config.closedValue || thisService.control.findCommandValue("DoorLock");
			thisService.control.unlockValue = that.config.openValue || thisService.control.findCommandValue("DoorUnLock");
			*/
