				...
				onControl.onValue = function () 
					{
						...
						if (onControl.config.onValue !== undefined)	{return (onControl.config.onValue)}
						else
						{
							if ( thisAlternate !== null) return (thisAlternate);
							if (thisOn !== null) return thisOn;
							return 255;
						}
					}
				onControl.offValue = function()
					{
							// user defined value overrides automatically detected value!
							if (onControl.config.offValue !== undefined)	{return (onControl.config.offValue) }
							else
								{
									var thisOff = onControl.findCommandValue("Off")
									if (thisOff !== null) return thisOff;
									return 0
								}
					}
