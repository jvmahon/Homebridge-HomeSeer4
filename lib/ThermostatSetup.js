	...
	thermostatService.thermostatType = 0;
		...
		if ( (deviceConfig.coolingSetpointRef !== undefined) && (deviceConfig.coolingSetpointRef != 0)) 	
			...
			switch(true)
			{
				...
				case 	statusField.endsWith("\u2109"): // The unicode Symbol for Degrees F
				...
				case 	statusField.endsWith("\u2103"): // The unicode Symbol for Degrees C
		...
		{ 
			...
			case 1: // Thermostat Supports Heating
			{
				thermostatService.getCharacteristic(Characteristic.TargetTemperature)
					.setConfigValues(deviceConfig);
				thermostatService.getCharacteristic(Characteristic.TargetHeatingCoolingState).setProps({validValues: [0, 1]});	
				break;
			}
			case 2: // Thermostat Supports Cooling
			{
				thermostatService.getCharacteristic(Characteristic.TargetTemperature)
					.setConfigValues(deviceConfig);
				thermostatService.getCharacteristic(Characteristic.TargetHeatingCoolingState).setProps({validValues: [0, 2]});
				break;
			}
