			...
			switch(true)
			{
				case 	statusField.endsWith("F"): 
					{	
						...
						thermostatService.getCharacteristic(Characteristic.TemperatureDisplayUnits).setProps({minValue:1, maxValue:1});
						break;
					}
				case  	statusField.endsWith("C"): 
					{	
						...
						thermostatService.getCharacteristic(Characteristic.TemperatureDisplayUnits).setProps({minValue:0, maxValue:0});
						break;	
					}
				default:
				{
