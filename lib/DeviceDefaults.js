...
var typeProperties =
{
	...
	"SecuritySystem":
	{
		Properties: 
		{
			...
			"armStayValue": 0,			// Value set to HomeSeer to indicate the system should be armed, with people home mode.
			"armAwayValue": 1,			// Value set to HomeSeer to indicate the system should be armed, with nobody home.
			"armNightValue": 2,			// Value set to HomeSeer to indicate the system should be armed, night mode.
			"disarmValue": 3,			// Value set to HomeSeer to indicate the system should be disarmed.
