...
exports.sendToHomeSeer = function (level, Characteristic, Service, forceHSValue, getHSValue, getHSControlValue, that )
{
		var url;
		var error = null;
		...
		console.log(yellow("Platform configuration is: " + Object.getOwnPropertyNames(globals.platformConfig)));
