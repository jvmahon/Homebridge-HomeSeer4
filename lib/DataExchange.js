...
exports.sendToHomeSeer = function (level, HomeSeerHost, Characteristic, Service, forceHSValue, getHSValue, getHSControlValue, that )
{
		var url;
		var error = null;
		...
		console.log(yellow("Platform configuration is: " + that.platformConfig));
