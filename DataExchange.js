...
exports.sendToHomeSeer = function (level, forceHSValue, getHSValue, getHSControlValue, that )
{
		var url;
		var error = null;
		...
		getHSControlValue(transmitRef, 1)
		getHSControlValue(transmitRef, 2)
